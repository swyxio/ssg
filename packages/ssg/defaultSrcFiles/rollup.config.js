// fallback rollup config
// not completely implemented yet bc we need to fork sapper deeper to achieve this...
...
const layoutPath = path.join(process.cwd(), './src/routes/_layout.svelte')
const preprocess = mdsvex({
  // extension: '.svexy', // the default is '.svexy', if you lack taste, you might want to change it
  layout: fs.existsSync(layoutPath) && layoutPath, // this needs to be an absolute path
